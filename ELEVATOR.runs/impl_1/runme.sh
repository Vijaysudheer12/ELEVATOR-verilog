...
HD_PWD='D:/Life/ELEVATOR/ELEVATOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smartelevator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source smartelevator.tcl -notrace
