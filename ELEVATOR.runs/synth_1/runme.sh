...
HD_PWD='D:/Life/ELEVATOR/ELEVATOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smartelevator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source smartelevator.tcl
